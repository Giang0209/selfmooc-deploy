        ...
        <div className="flex justify-between gap-2 bg-gray-100 p-2 rounded-2xl">
          {mode === 'login' && (
            <button
              ...
              className={`flex-1 flex flex-col items-center justify-center py-3 px-1 rounded-xl transition-all transform ${role === 'student' ? 'bg-yellow-400 text-yellow-900 shadow-[0_4px_0_rgb(202,138,4)] -translate-y-1' : 'bg-white text-gray-500 shadow-sm hover:shadow-md hover:-translate-y-0.5'
                }`}
            >
          ...
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center py-3 px-1 rounded-xl transition-all transform ${role === 'teacher' ? 'bg-blue-400 text-blue-900 shadow-[0_4px_0_rgb(37,99,235)] -translate-y-1' : 'bg-white text-gray-500 shadow-sm hover:shadow-md hover:-translate-y-0.5'
              }`}
          >
            <span className="text-2xl mb-1 drop-shadow-sm">👩‍🏫</span>
          ...
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center py-3 px-1 rounded-xl transition-all transform ${role === 'parent' ? 'bg-green-400 text-green-900 shadow-[0_4px_0_rgb(22,163,74)] -translate-y-1' : 'bg-white text-gray-500 shadow-sm hover:shadow-md hover:-translate-y-0.5'
              }`}
          >
            <span className="text-2xl mb-1 drop-shadow-sm">👨‍👩‍👧</span>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 text-base font-bold text-gray-900 bg-white border-2 border-gray-200 rounded-2xl focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all placeholder-gray-400 tracking-widest"
                  placeholder="••••••••"
                />
